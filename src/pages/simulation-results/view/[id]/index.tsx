...
import { getSimulationResultById } from 'apiSdk/simulation-results';
...
function SimulationResultViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Simulation Result Detail View
          </Text>
          {hasAccess('simulation_result', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/simulation-results/edit/${data?.id}`} passHref legacyBehavior>
              <Button
            ...
            <Box>
              {hasAccess('simulation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/simulations/view/${data?.simulation?.id}`}>
                      {data?.simulation?.pulse_sequence}
                    </Link>
                  </Text>
                </Flex>
              )}
